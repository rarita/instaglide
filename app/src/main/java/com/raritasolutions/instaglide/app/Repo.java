...
// Каноничный паттерн репозиторий, за исключением отсутствия кэша.
// В ходе разработки было решено, что скорости БД хватит, чтобы отказаться от кэша и упростить класс.
public class Repo {
